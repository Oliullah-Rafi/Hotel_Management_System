...
namespace HMSApp.Controllers
{
    public class RoomController : ApiController
    {
        ...
        public HttpResponseMessage Create(RoomDTO obj)
        {
            try
            {
                var data = RoomService.Add(obj);
        ...
        public HttpResponseMessage Update(RoomDTO obj)
        {

            try
            {
                var updatedData = RoomService.Update(obj);
